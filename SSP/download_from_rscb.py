...
for file in difference:
   ftp_link = "ftp://ftp.pdbj.org/pub/pdb/data/structures/all/pdb/"+allfilesdict[file].split("\"")[1]
   print ftp_link
   os.system("wget -e use_proxy=yes -e ftp_proxy=infpapxvip.it.unsw.edu.au:8080 "+ftp_link)
