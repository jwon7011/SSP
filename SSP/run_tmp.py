...
def main(analysis_type, command_variables, threshold):
    pdb_dir = fopen("C:\\xampp\\htdocs\\python\\SSP\\absolute_path_of_pdb_files")[0].strip()                   ## EDIT
    dssp_dir = None
    ...
    write_path = "C:\\xampp\\htdocs\\python\\Analyses\\"+str(int(random.random()*100000000))+"_"+date_+".xls"     ## EDIT
    #x.save(write_path)
    ...
    erfile = open("C:\\xampp\\htdocs\\python\\Errors\\error_"+analysis_type+"_"+date_+".log","w")               ## EDIT
    runlist = None
    ...
    for i in run_list:
          ...
          if found == 0:
             ...
             os.system("python C:\\xampp\htdocs\python\SSP\create_dssp.py "+pdb_dir+os.path.dirname(i)+"\\"+os.path.basename(i)+" "+outpath)
             print "CREATE "
    print "Done"
...
#             if not os.path.isdir(pdb_dir+os.path.dirname(i)+"\\dsspout"):
#                os.mkdir(pdb_dir+os.path.dirname(i)+"\\dsspout")
#             os.system("C:\\xampp\\htdocs\\python\\SSP\\dsspcmbi.exe "+pdb_dir+os.path.dirname(i)+"\\"+os.path.basename(i)+" > "+pdb_dir+os.path.dirname(i)+"\\dsspout\\"+i[:-3].split("\\")[-1]+"dssp")         ## EDIT
